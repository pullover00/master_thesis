...
def headrail(height, width, position):
    ...
    # Create mesh
    xNode = list(range(0, b+1, 5))
    for i, x_pos in enumerate(xNode):
        mp.CreateNewNode(i + 1, x_pos, 0.0, 0.0) # number, x, y, z) 
